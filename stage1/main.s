	...
	.type	print_token_lexeme, @function
print_token_lexeme:
	addi	sp,sp,-48
	sd	ra,40(sp)
	sd	s0,32(sp)
...
.L2:
	...
	addi	sp,sp,48
	jr	ra
	.size	print_token_lexeme, .-print_token_lexeme
	.align	1
	.globl	interpret_arithmetic
	.type	interpret_arithmetic, @function
...
.L11:
	...
	addi	sp,sp,48
	jr	ra
	.size	interpret_arithmetic, .-interpret_arithmetic
	.section	.rodata
	.align	3
.LC0:
